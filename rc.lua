...
local editor       = "vi" or os.getenv("EDITOR") or "nvim"
...
globalkeys = mytable.join(
    ...
    -- rofi with Dedicated Graphics
    awful.key({ modkey, "Control" }, "d", function ()
            os.execute(string.format("switcherooctl launch rofi -show %s -theme %s",
            'drun', 'dmenu'))
        end,
        {description = "show rofi w/ nvidia", group = "launcher"}),
